    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        npc.conversationOptions = {
            1: {
                ...
                answer: 'Znajdujesz się w fortecy zakonu Wielkiego Stonogiasza. Żyjemy tutaj i służymy naszemu panu,' +
            ...
            2: {
                ...
                answer: 'Nie sprzedajemy naszych wyrobów obcym, ale dobrze ci z oczu patrzy, więc dla ciebie zrobię wyjątek. ' +
